...
client.on("message", async (msg) => {
  ...
  if (contatosRespondidos.has(msg.from)) {
    console.log(
      `Mensagem ignorada de ${msg.from} (já respondido recentemente).`
    );
    return;
  }
  ...
  try {
    ...
    const mensagemFerias =
      ...
      `Para assuntos urgentes ou relacionados ao setor de transportes da Prefeitura de Nova Ponte, por favor, entre em contato através dos canais abaixo:\n\n` +
      `📞 *Fixo:* (34) 3356-8050\n` +
